...
const qdropboxjson_entry_type QDROPBOXJSON_TYPE_INT     = 'n';
const qdropboxjson_entry_type QDROPBOXJSON_TYPE_INT64   = 'N';
...
const qdropboxjson_entry_type QDROPBOXJSON_TYPE_UINT64  = 'U';
...
union qdropboxjson_value{
    QDropbox2Json  *json; //!< Used to store subjsons (JSON in JSON)
 ...
 */
class QDROPBOXSHARED_EXPORT QDropbox2Json : public QObject
{
    Q_OBJECT
public:
    /*!
     ...
     */
    QDropbox2Json(QObject *parent = 0);
     ...
     */
    QDropbox2Json(QString strJson, QObject *parent = 0);
     ...
     */
    QDropbox2Json(const QDropbox2Json &other);
    ...
    enum DataType
    {
        NumberType,         //!< 32-bit number-based type (interpreted as qint64)
        Number64Type,       //!< 64-bit number-based type (interpreted as qint64)
        ...
        UnsignedIntType,    //!< 32-bit number-based type unsigned (only applied if NumberType does not match)
        UnsignedInt64Type,  //!< 64-bit number-based type unsigned (only applied if Number64Type does not match)
    ...
    /*!
      ...
      is omitted and it is tried to convert the value regardless of the real data type.
     */
    qint64 getInt64(QString key, bool force = false);

    void setInt64(QString key, qint64 value);
    ...
    /*!
      ...
      is omitted and it is tried to convert the value regardless of the real data type.
     */
    quint64 getUInt64(QString key, bool force = false);

    void setUInt64(QString key, quint64 value);
     ...
     */
    QDropbox2Json *getJson(QString key);

    void setJson(QString key, QDropbox2Json value);
    ...
    */
    QDropbox2Json& operator=(QDropbox2Json&);
    ...
    */
    int compare(const QDropbox2Json& other);
